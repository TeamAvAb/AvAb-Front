    ...
    <FlowWriteWrap>
      ...
      <FlowwriteDetail>
        <div>
          ...
          >
            <span className={`genderBtn ${selectedGenders.includes('FEMALE') ? 'clicked' : ''}`}>
              여성
            </span>
          </GenderButton>
          <GenderButton
          ...
          >
            <span className={`genderBtn ${selectedGenders.includes('MALE') ? 'clicked' : ''}`}>
              남성
            </span>
          </GenderButton>
          <div>
            ...
            {ageGroups.map((age) => (
              <AgeButton key={age[1]} onClick={() => handleAgeClick(age[1])}>
                <AgeSpan clicked={selectedAges.includes(age[1])}>{age[0]}</AgeSpan>
              </AgeButton>
            ))}
          </div>
